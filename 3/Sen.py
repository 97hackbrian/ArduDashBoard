...
def leds(dis):
    ...
    if dis<=25:
        l1=Label(frame,bg="red",width=11,textvariable =" ",fg="red")
        l1.grid(row=2,column=0, padx=5,pady=5)
    else:
        l1=Label(frame,bg="black",width=11,textvariable =" ",fg="black")
        l1.grid(row=2,column=0, padx=5,pady=5)
    if dis<=50:
        l2=Label(frame,bg="red",width=11,textvariable =" ",fg="red")
        l2.grid(row=3,column=0, padx=5,pady=5)
    else:
        l2=Label(frame,bg="black",width=11,textvariable =" ",fg="black")
        l2.grid(row=3,column=0, padx=5,pady=5)
    if dis<=75:
        l3=Label(frame,bg="red",width=11,textvariable =" ",fg="red")
        l3.grid(row=4,column=0, padx=5,pady=5)
    else:
        l3=Label(frame,bg="black",width=11,textvariable =" ",fg="black")
        l3.grid(row=4,column=0, padx=5,pady=5)
    if dis<=100:
        l2=Label(frame,bg="red",width=11,textvariable =" ",fg="red")
        l2.grid(row=5,column=0, padx=5,pady=5)
    else:
        l2=Label(frame,bg="black",width=11,textvariable =" ",fg="black")
        l2.grid(row=5,column=0, padx=5,pady=5)
...
plt.title("Grafica - 0 - 150 cm",color='red',size=16)
...
Iniciar1 = Button(frame,command= Iniciar, text= "Iniciar ",bg="blue",fg="white", font="Helvetica 14 bold",width=9,justify="center")
Iniciar1.grid(row=1,column=0, padx=5,pady=5)
...
salir.grid(row=9,column=0, padx=5,pady=125)
